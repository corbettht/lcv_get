...
# -*- coding: utf-8 -*-
#
# lcv_get documentation build configuration file
#
...
latex_documents = [
    (master_doc, 'lcv_get.tex', 'lcv_get Documentation',
     'corbettht', 'manual'),
]
...
man_pages = [
    (master_doc, 'lcv_get', 'lcv_get Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'lcv_get', 'lcv_get Documentation',
     author, 'lcv_get', 'One line description of project.',
     'Miscellaneous'),
]
